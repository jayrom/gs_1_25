...
DROP TABLE T_4E_047_SENSOR_READINGS CASCADE CONSTRAINTS;
...
CREATE TABLE T_4E_047_SENSOR_READINGS (
    reading_id NUMBER(5) NOT NULL,
    reading_timestamp DATE NOT NULL,
    reading_pressure NUMBER (6, 2)
)

ALTER TABLE T_4E_047_SENSOR_READINGS
    ADD CONSTRAINT PK_T_4E_047_SENSOR_READINGS PRIMARY KEY (reading_id);
CREATE SEQUENCE SEQ_T_4E_047_SENSOR_READINGS START WITH 1 INCREMENT BY 1;
